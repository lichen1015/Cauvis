...
from ..utils import gt_instances_preprocess, yolo_make_divisible as make_divisible
...
class YOLOv8Head(YOLOv5Head):
    ...
    def __init__(self,
                 ...
                 prior_generator: ConfigType = dict(
                     ...
                     offset=0.5,
                     strides=[8, 16, 32]),
                 bbox_coder: ConfigType = dict(type='YOLODistancePointBBoxCoder'),  # TODO need modify
