...
classes = 7 # backbone=dict(type='FrozenDINOViT'),
model = dict(backbone=dict(type='FrozenDINOViT'),roi_head=dict(bbox_head=dict(num_classes=classes)))
